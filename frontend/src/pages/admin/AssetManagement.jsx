...
const AssetManagement = () => {
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold text-slate-900 mb-2">Asset Management</h1>
            <p className="text-slate-500 mb-10 font-semibold uppercase tracking-widest text-xs">Global Facility Catalogue Control</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="p-8 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 group">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-2 leading-none">Lecture Hall B-102</h3>
                    ...
                    <div className="flex justify-between items-center bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        ...
                        <span className="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-[10px] font-bold tracking-tight uppercase">ACTIVE</span>
                    </div>
                </div>
            </div>
        </div>
