...
const Unauthorized = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[85vh] p-8 text-center animate-in zoom-in duration-700 bg-slate-50/30">
            ...
            {/* Error Message */}
            <h1 className="text-6xl font-bold text-primary-dark mb-6 tracking-tight">Access Restricted</h1>
            <p className="text-slate-500 text-2xl max-w-xl mb-12 font-medium leading-relaxed">
                ...
                Please contact the <span className="text-accent-orange font-bold">System Administrator</span> if you believe this is an error.
            </p>
