            ...
            <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-700">
                ...
                <div className="bg-white/80 backdrop-blur-2xl p-8 md:p-10 rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] border border-white flex flex-col group">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-4 py-4 px-8 bg-white border border-slate-200 text-slate-700 rounded-2xl font-bold text-sm shadow-sm hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95 mb-6 group/btn"
                    >
