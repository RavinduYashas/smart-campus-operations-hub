  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 mb-10">
        <label className="block text-sm font-bold text-slate-400 uppercase tracking-widest mb-2">Issue / Category</label>
        ...
        <div className="flex justify-between items-center bg-blue-50 p-6 rounded-2xl border border-blue-100/50">
            <span className="text-sm font-semibold text-blue-700">Attach Evidence / Photos (Max 3)</span>
            <button className="bg-white px-4 py-2 border rounded-xl text-blue-600 font-semibold shadow-sm">Browse Files</button>
        </div>

        <button className="w-full mt-8 py-5 bg-slate-900 text-white rounded-2xl font-bold text-lg shadow-xl shadow-slate-200 hover:-translate-y-1 transition-all active:scale-95">
          Submit Report
        </button>
      </div>
    </div>
