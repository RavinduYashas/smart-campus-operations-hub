    ...
    <div className="p-8">
      ...
      <div className="space-y-4">
        ...
        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm flex justify-between items-center">
          <div>
            <h3 className="font-bold text-lg">Lab-02 / April 24, 2026</h3>
            <p className="text-sm text-gray-500">09:00 AM - 12:00 PM | Research Workshop</p>
          </div>
          <span className="px-4 py-2 bg-amber-100 text-amber-700 rounded-xl text-xs font-black uppercase tracking-widest">PENDING</span>
        </div>
      </div>
    </div>
  );
